...
This project is built as a compact analyst workflow rather than a dashboard alone:
...
The work demonstrates protocol-to-data mapping, relational-table reasoning, data-quality awareness, reproducible Python, and clear communication for clinical operations and health-data audiences.
...
If you do not install the package in editable mode, run commands with `PYTHONPATH=src`.
...
All data are synthetic. The project does not contain real patient data, real site data, restricted exports, EDC exports, sponsor data, or identifiable information.

## Background

I am a First Class Biomedical Science graduate with governed hospital-data experience, Python/scikit-learn workflows, ICD-coded feature engineering, health-data governance exposure, scientific communication experience, and clinical informatics preparation in progress. This project extends that foundation into a public, synthetic trial-operations workflow.
